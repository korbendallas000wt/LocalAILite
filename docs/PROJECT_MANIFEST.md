...
| core/updater.py | v2.4 | Модуль обновлений v2.4: проверка версий через GitHub API (IPv4, обход блокировки raw.githubusercontent.com) + скачивание/установка (QThread). Явный таймаут 30с, base64-декодирование ответов API. |
