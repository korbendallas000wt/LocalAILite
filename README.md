...
- 📊 **Счётчик контекста** — видно, сколько токенов занято и сколько осталось до лимита. Цвет подскажет, когда контекст заполняется.
...
<!-- Скриншоты будут добавлены перед релизом. Файлы хранить в docs/screenshots/, вставлять относительными ссылками вида ![Описание](docs/screenshots/имя_файла.png) -->
