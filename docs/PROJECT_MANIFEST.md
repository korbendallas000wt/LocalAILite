...
| core/updater.py | v2.3 | Модуль обновлений v2.3: проверка версий через GitHub API (IPv4, обход блокировки raw.githubusercontent.com) + скачивание/установка (QThread). Явный таймаут 10с, base64-декодирование ответов API. |
