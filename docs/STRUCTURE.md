...
## Файлы проекта
    ...
    │   └── updater.py                     # Модуль обновлений v2.4: проверка версий через GitHub API (IPv4, обход блокировки raw.githubusercontent.com) + скачивание/установка (QThread). Явный таймаут 30с, base64-декодирование ответов API. Фикс парсинга CHANGELOG (матчит и `-`, и `—`)
    │
...
- **updater.py** — модуль обновлений v2.4: проверка версий через GitHub API (обход блокировки raw.githubusercontent.com) + скачивание/установка (QThread), явный таймаут 30с, base64-декодирование ответов API. Фикс парсинга CHANGELOG
