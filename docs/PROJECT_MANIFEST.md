...
| core/updater.py | v2.2 | Модуль обновлений v2.2: проверка версий (асинхронно, QNetworkAccessManager) + скачивание/установка (QThread). Фикс гонки GC для старых PyQt. |
